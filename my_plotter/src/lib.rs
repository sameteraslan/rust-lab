//! # MyPlotter Library
//!
//! **MyPlotter** is a versatile and modular Rust library for creating and managing a wide variety of charts and graphs. 
//! Designed with flexibility and extensibility in mind, MyPlotter provides a powerful API for data visualization, 
...
//!
//! ## Modules
//! MyPlotter is organized into a set of modules that define the core components of the library:
//!
//! ### [`figure`]
...
//!
//! ## License
//! MyPlotter is open-source and licensed under the MIT license. Contributions are welcome!
